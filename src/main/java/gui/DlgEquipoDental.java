...
public class DlgEquipoDental extends JDialog implements ActionListener {
	...
	void listar() {
		...
		try {
			...
			for (EquipoDental equipoDental : lstEquiposDentales) {
				...
				imprimir("Dentista...............: " + dentista.getCop() + " - " + dentista.getNombre_completo());
	...
	void adicionar() {
		...
		try {
			...
			EquipoDental equipoDental = new EquipoDental(null, nombre, costo, null, estado, dentista);
	...
	void modificar() {
		...
		Double costo = Double.parseDouble(txtCosto.getText());
		String estado = (String) cboEstados.getSelectedItem();
		LocalDate fechaAdquisicion = LocalDate.parse(txtFechaAdquisicion.getText());
		Dentista dentista = (Dentista) cboDentistas.getSelectedItem();
		...
		try {
			...
			EquipoDental equipoDental = new EquipoDental(nroEquipo, nombre, costo, fechaAdquisicion, estado, dentista);
